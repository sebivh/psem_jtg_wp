...
<div class="cover">
	...
	<?php
	// Only Show Cover if specified
	if(get_theme_mod("set-def-location-show-cover")) {

		echo('<div class="thumbnail-container">' . PHP_EOL);
...
?>
	...
	if(get_theme_mod("set-def-location-show-address")) {

		echo('<div class="metaDataDisplay">' . PHP_EOL);
	...
	?>
<?php
if(get_theme_mod("set-def-location-show-gallery")) {
	echo '<h2>Weitere Artikel</h2>';
